...
RegisterNetEvent('hs_carsharing:unlockVehicle')
AddEventHandler('hs_carsharing:unlockVehicle', function(veh)
        ...
        while true do
            ...
            if currentveh == current then
                ...
                if currentHealth < lastDamage - (1000 * (Config.damagePercentForPenalty / 100)) then
                    ...
                    TriggerServerEvent("hs_carsharing:pay", Config.damagePenalty)
            ...
            elseif current ~= nil then
                ...
                if Config.penaltyOutsideZone > 0 and inZone() == false then
                	TriggerServerEvent("hs_carsharing:pay", Config.penaltyOutsideZone)
                ...
                TriggerServerEvent("hs_carsharing:pay", price)
                                    ...
                                    ESX.TriggerServerCallback(
                                        ...
                                        function(hasMoney)
                                            if hasMoney then
                                                ...
                                                TriggerServerEvent('hs_carsharing:unlockVehicle', NetworkGetNetworkIdFromEntity(i.vehicle))
